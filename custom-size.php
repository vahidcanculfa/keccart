...
<main class="container custom-3d-page">
    <div class="custom-3d-card">
        ...
        <div class="custom-3d-grid">
            <form class="custom-3d-form" id="custom3dForm" method="POST" action="<?php echo BASE_URL; ?>core/3d-request.php" enctype="multipart/form-data" data-success="<?php echo BASE_URL; ?>custom-size.php?3d=success">
